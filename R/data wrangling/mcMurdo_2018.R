...
infile1 <- 'data/raw data/mcMurdo_2018/dt1.csv'
...
summary(NH4_MM)
summary(CHLA_UG_L)
summary(CHLA_BL_UG_L)
summary(CHLA_GR_UG_L)
summary(CHLA_BR_UG_L)
summary(CHLA_PE_UG_L)
summary(CHLA_TOTAL_UG_L)
summary(FV_FM_BL)
summary(FV_FM_GR)
summary(FV_FM_BR)
summary(FV_FM_PE)
...
summary(NO_BR)
summary(NO_PE)
summary(PHOTOTROPHS_CELLS_ML)
summary(HETEROTROPHS_LARGE_CELLS_ML)
summary(HETEROTROPHS_SMALL_CELLS_ML)
summary(ACCN_16S)
summary(ACCN_18S)
summary(COMMENTS)
detach(dt1)

infile2 <- 'data/raw data/mcMurdo_2018/dt2.csv'
...
summary(SAMPLE_TYPE)
summary(DEPTH_M)
summary(CONDUCTIVITY_MS_CM)
summary(TEMPERATURE_C)
summary(PAR_UMOL_M2_S)
summary(COMMENTS)
detach(dt2)
