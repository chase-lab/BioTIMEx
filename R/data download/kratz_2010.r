...
infile1 <- 'data/raw data/kratz_2010/ntl251_v1.csv'
if(!dir.exists('data/raw data/kratz_2010/') || !file.exists(infile1))   {
   dir.create('data/raw data/kratz_2010/',  showWarnings = FALSE)
